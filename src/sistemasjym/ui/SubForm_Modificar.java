 ...
 * @author luis
 */
public class SubForm_Modificar extends javax.swing.JFrame {
    ...
    public SubForm_Modificar(String codigo,String nombre,String descripcion,String categoria,String color,String talla,String fechaafabrica,String fechaaempresa,String cantidadtotal,String cantidaddisponible,String cantidadenespera,String fechaderegistro ) {
        initComponents();
        ...
        JCColor.setSelectedItem(color);
        JCTalla.setSelectedItem(talla);
        JSCantidad.setValue(Integer.parseInt((cantidadtotal)));
        try {
            SimpleDateFormat formato = new SimpleDateFormat("dd/MMM/yyyy");
            java.util.Date fechaDate = formato.parse(fechaderegistro);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(JCCategoria, 0, 146, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(JDFechaDeRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(9, 9, 9))))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(JTFCodigo.getText()!= "" && JTFNombre.getText()!= "" && (String)JCCategoria.getSelectedItem()!= "" && JTFDescripcion.getText()!= "" && (String)JCColor.getSelectedItem()!= "" && JCTalla.getSelectedItem()!="" && JSCantidad.getValue()!="" && JDFechaDeRegistro.getDate()!= null){
            ...
            try {
                ...
                String fechaaempresa = pfechaaempresa;//No se ha devuelto a la empresa
                String cantidaddisponible = JSCantidad.getValue().toString();
                String cantidadenespera = pcantidadenespera;//Al regstrar un artículo,aún no se han mandado a procesar productos de este tipo

                
                
                ControladorArticulo ca = new ControladorArticulo();
                ca.modificarArticulo(codigo, nombre, descripcion, categoria, color, talla, fechaafabrica, fechaaempresa, cantidadtotal, cantidaddisponible, cantidadenespera, fechaderegistro);
                limpiarCajasDeTexto();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubForm_Modificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new SubForm_Modificar(pcodigo, pnombre, pdescripcion, pcategoria, pcolor, ptalla, pfechaafabrica, pfechaaempresa, pcantidadtotal, pcantidaddisponible, pcantidadenespera, pfechaderegistro).setVisible(true);
            }
        });
    }
