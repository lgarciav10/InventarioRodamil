 ...
 * @author luis
 */
public class Form_HistorialDevoluciones extends javax.swing.JFrame {

    
    private TableRowSorter trsfiltro;
    String filtro;
    
    public Form_HistorialDevoluciones() {
        initComponents();
    ...
    public void cargarDevoluciones(){
        ...
        DefaultTableModel m;
        try {
            String titulo[]={"Número","Código Devolución","Código Artículo","Nombre Artículo","Cantidad Devuelta","Nombre Fábrica","Código Fábrica","Fecha Devolución"};
            ...
            cdb.un_sql="select * from devoluciones";//selecciono todos de la tabla devoluciones
    ...
    private void eliminar(){
        ...
        if (clie != -1){
        try {
            String codigodevolucion = (TBLArticulos.getValueAt(clie, 1).toString());    
          
            ControladorDevolucion cd = new ControladorDevolucion();
            cd.eliminarDevolucion(codigodevolucion);
            cargarDevoluciones();          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_HistorialDevoluciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_HistorialDevoluciones().setVisible(true);
            }
        });
    }
